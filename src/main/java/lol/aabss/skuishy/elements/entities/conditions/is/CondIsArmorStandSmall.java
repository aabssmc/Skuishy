...
@Since("2.8")
public class CondIsArmorStandSmall extends EntityCondition<ArmorStand> {

    static {
        register(CondIsArmorStandSmall.class, PropertyType.HAVE, "[armor[ |-]stand] small", "entities");
    }
